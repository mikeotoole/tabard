...
wow = Game.create(:name => "World of Warcraft", :type_helper => "Wow")
swtor = Game.create(:name => "Star Wars the Old Republic", :type_helper => "Swtor")
...
viewUser = User.create(:email => "billy@robo.com", :password => "password", :roles => [viewerRole], :user_profile => userProfile, :game_profiles => [wowProfile,swtorProfile])
