...
discSpace1 = DiscussionSpace.create(:name => "Off Topic", :system => true)
...
allDiscussionPermission = Permission.create(:permissionable => discussionSpaceResource, :name => "Full Access Discussion", :show_p => true, :create_p => true, :update_p => true, :delete_p => true)
...
viewGeneralDiscussionSpacePermission = Permission.create(:permissionable => discSpace, :name => "View Access General Discussion Space", :show_p => true, :create_p => false, :update_p => false, :delete_p => false)
adminRole = Role.create(:name => "Admin", :permissions => [allUserPermission,allRolePermission,allGamePermission,allDiscussionSpacePermission,allDiscussionPermission])
