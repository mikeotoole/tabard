...
blaggarth = Character.create(:name => "Blaggarth", :faction => "Alliance", :race => "Dwarf", :server => "Medivh", :rank => "MT", :game => wow)
adminProfile = UserProfile.create(:name => "Admin")
wowProfile = GameProfile.create(:name => "Wow profile", :characters => [blaggarth], :game => wow)
...
adminUser = User.create(:email => "admin@example.com", :password => "password", :roles => [adminRole], :user_profile => adminProfile, :game_profiles => [wowProfile])
