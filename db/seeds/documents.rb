...
4) ONE ACCOUNT ONLY - ACCURATE INFORMATION REQUIRED Individual persons may only have one active Account at any given time. The simultaneous use of two or more accounts at any given time by a single person is a violation of this Agreement and is grounds for immediate termination of Service. By applying for an Account, Users certify that the information that the personal information provided is true and accurate. Personal information provided by Users is safeguarded by the Company pursuant to its *Privacy@crumblin.com*.
...
* Posting,delivering,storingorreceivinganymaterialthatisconsideredillegal contraband under Federal, State or local law

* UtilizingtheService,oranyotherassociatedresources,forconducting,encouraging or perpetuating illegal acts or activity

* AccessingtheAccountsorotherprivatedataofanyotherUserwithoutthatUser's prior written consent

* Gaining unauthorized entry in to any service, server or associated resources operated by or otherwise associated with the Company
...
* Using any automated means, including any bot or spider-crawling, togather information about other Users
...
* Reverse-engineering any portion of the Service or Service functions, orde-compiling the same with the intent to discern the source code of the Service
...
2) *Disclaimer of Warranties. Except where disclaimer of warrantees are prohibited by law, the Service is provided, and by accepting these TOS you are agreeing to use of Service, on an As Is basis and acknowledging the following warranty disclaimers. All express or implied warranties, including, but not limited to, warranty of merchantability, warranty of fitness for use, warranty of title, and warranty of non-infringement are hereby disclaimed wholly, and completely. Furthermore, We do not warranty in any way that the Service, and functions or purposes served within or available through the Service, will work in any particular manner, will be error free, uninterrupted, free of viruses, worms or other malware, or error free. If any particular portion of these disclaimers of warranty shall be found, by a court of competent jurisdiction, to be unlawful or otherwise unenforceable, then all remaining portions shall continue to have full force and effect.*

3) *Release and waiver of liability. Neither the Company nor any of its elected or appointed officers, employees or agents shall be liable for any liability, penalty, fee, fine, attorney's fees, or any other costs, associated with, stemming from, or in any other way pertaining to Your use of the Services or reliance on the Service, regardless of the theory of liability including, but not limited to, direct, indirect, special, consequential, incidental, exemplary, punitive or any other type of damages, lost or damaged data, damage to equipment, lost profits, personal injury or death, all of which are excluded, waived and disclaimed in their entirety and in perpetuity by the agreement of the parties. Your agreement to exclude, waive and disclaim shall extend, in perpetuity, to your estate, descendants, heirs and assigns. If any particular portion of these disclaimers of liability shall be found, by a court of competent jurisdiction, to be unlawful or otherwise unenforceable, then all remaining portions shall continue to have full force and effect.*

4) *Indemnification and hold harmless.* You agree to, and shall indemnify, defend, and hold completely harmless the Company, its elected or appointed officers, employees, and agents from and against any claims, damages (of any type, including punitive or exemplary damagers), penalties, fees, fines, and costs, claimed by any third party or imposed by any governmental entity or court of law, for your actions or inactions in any way relevant to, stemming from, or resulting from your use or misuse of the Service. This duty to defend, indemnify and hold harmless shall include payment of any reasonable attorney's fees incurred therefrom.

5) *Applicability of TOS*. Except as prohibited by law these TOS shall be binding on You, your estate, descendants, heirs, and assigns.

6) *License for User Content.* Certain functionality of the Services will allow Users to upload or share data, information, images, videos or text in a variety of formats or forums (collectively, "User Content"). In addition to the submission formats or forums incidental and part of the use of the Service itself, this may also include submissions for contests, Wiki pages, public user forums or other interactive services. You grant the Company a perpetual sub-licensable world-wide license to use any and all such User Content, including derivatives thereof, in any format that the Company sees fit, whether for promotional, commercial, or other purposes, and without need to seek your approval or consent prior to such use. Furthermore, you waive, in perpetuity, any right you may have to moral rights or residual payment, for any such use that might be commercial in nature or that may otherwise generate income or any benefit for the Company.

7) *Non-Responsibility for Third-Party Actions.* The Services are accessible to many Users throughout the country. It is impossible for the Company to monitor the activities, including the contents of postings, of Users or other third parties and Company does not in any way promise or undertake to do so. Therefore, Company disclaims all responsibility for actions of, or postings by, Users or other third parties, even to the extent that they may violate the rights of others or constitute a crime. Provided, however, that the Company will take reasonable and appropriate steps to investigate violations of the *ACCEPTABLE USE POLICY* when violations are reported, and will also take action as described below in the *Digital Millennium Copyright Act Notices* section.
...
Attn: DMCA Notice <br/>
c/o Daniel Boyd, CPA <br/>
DigitalAugment Inc. <br/>
202 N 3rd Ave <br/>
Pasco, WA 99301 <br/>

An email sent to *DMCA@crumblin.com* will assist in expediting the handling of your notice. *However, because of its inherent unreliability, the  email communication, in itself, should not be deemed sufficient notice. If the Company does not actually receive an email notice and no mailed notice is sent, then your notice may not have its desired effect.*
...
12) *Mandatory Arbitration.* Any disputes relating to this Agreement and to the Services, shall be resolved by binding arbitration only, and the parties hereby waive their otherwise inherent right to file a lawsuit in a court of competent jurisdiction for relief. *This means that by accepting this Agreement, you are waiving your right to file a lawsuit in court and to form a class for purposes of a class action lawsuit.* Prior to commencing with arbitration, any aggrieved party is strongly encouraged to contact the Company's dispute resolution center at: *Disputes@crumblin.com*. If arbitration becomes necessary, then the parties agree that it shall be conducted in the following manner:
...
13) *Venue.* Venue for any legal action requiring an action in court, including any legal action to enforce the *Mandatory Arbitration* provisions herein, shall only be proper in a State or Federal court of competent jurisdiction, physically located within the counties of Benton or Franklin, in the State of Washington.

14) *Choice of Law.* This Agreement created under the laws of the State of Washington, and for all purposes shall be interpreted under Washington State laws governing contractual transactions between Washington State residents.

15) *Survivability.* Any provision of these TOS that are, by their nature, intended to survive the termination of this Agreement, shall so survive. In particular, the following provisions shall survive indefinitely following the termination of this Agreement: *1. License to Use the Service; 2. Disclaimer of Warranties; 3. Release and Waiver of Liability; 4. Indemnification and Hold Harmless; 5. Applicability of TOS; 6. License for User Content; Non-Responsibility for Third-Party Actions; DMCA Notices; 9. Brand Assets Belonging to the Company; 12. Mandatory Arbitration; 13. Venue; 14. Choice of Law; 16. No Legal Notices Accepted; and 17. Severability.*

16) *No Legal Notices Accepted.* The Company does not, by operating the Service or any other website, social media account or other digital presence, consent to service of legal notice of any sort whatsoever, by way of delivery through resources associated with the Service or such other website, social media account or other digital presence, including any email addresses that may be found therein. Instead, any such legal notices shall be served in the manner otherwise directed by applicable law.
...
None of the Company's services are intended for available to children under the age of 13 and We never knowingly solicit or collect any information whatsoever from or about children under the age of 13. If you become aware that your child under the age of 13 has been using the Company's services or has submitted information to Us, please let us know by email at *Underage@Crumblin.com*. If we become aware that a child under the age of 13 has been using our services or submitting information to us, We will immediately terminate the child's account and will take reasonable steps to delete the submitted information.
...
Please contact us immediately by email at *Spam@Crumblin.com* if you believe that you have either received unwanted commercial solicitations or if you have tried, and have been unable to unsubscribe from commercial solicitations.
...
If you decide to cancel your account with the Service, We will continue to abide by this Privacy Policy. However, since individual user data is almost always heavily ingrained with the framework of the Service as well as the user communities that are based on the Service, none of your personal information will be actually deleted. Instead, your personal information will be archived and your personal account and User Profile will be deactived. Once your personal information is archived and your personal account and User Profile is deactivated, other users will not be able to access any of your personal information but it will remain accessible to Us and our Enterprise Partners. Please note, however, that even after your User Profile is archived, cached versions of it may still be available throughout the internet from sources other than servers or networks that We operate or use. Information that you have sent to other Users, and information you have posted in public areas of the Services, including, but not limited to Wiki contributions, public comments, and forum posts, will not be affected, and will continue to be available to the public.

*Reports of Privacy Concerns*

We take your privacy concerns very seriously. If you have questions about the policy or a concern about your privacy, or the application of this Privacy Policy, please contact Privacy@Crumblin.com and We will address your concern immediately.
