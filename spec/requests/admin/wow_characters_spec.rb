...
describe "ActiveAdmin WowCharacter" do
  ...
  describe "#new" do
    it "raises error ActionNotFound" do
      lambda { visit new_admin_wow_character_url }.should raise_error(AbstractController::ActionNotFound)
    end    
  end
 
  describe "#create" do
    it "raises error ActionNotFound" do
      lambda { page.driver.post("/admin/wow_characters") }.should raise_error(AbstractController::ActionNotFound)
    end
  end 

  describe "#edit" do
    it "raises error ActionNotFound" do
      lambda { visit edit_admin_wow_character_url(:id => character.id) }.should raise_error(AbstractController::ActionNotFound)
    end  
  end

  describe "#update" do 
    it "raises error ActionNotFound" do
      lambda { page.driver.put("/admin/wow_characters/#{character.id}") }.should raise_error(AbstractController::ActionNotFound)
    end  
  end
