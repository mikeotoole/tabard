...
describe "community_games/new" do
  before(:each) do
    assign(:community_game, stub_model(CommunityGame,
      :community_id => 1,
      :game_id => 1,
  ...
  it "renders new community_game form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => community_games_path, :method => "post" do
