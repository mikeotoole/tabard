...
describe "ActiveAdmin AdminUser" do
  ...
  describe "#index" do
    it "returns 200 when logged in as superadmin" do
      ...
      current_url.should == alexandria_admin_users_url
    end
  ...
  describe "#show" do
    it "returns 200 when logged in as superadmin" do
      ...
      visit alexandria_admin_user_url(:id => admin.id)
      page.status_code.should == 200
      current_url.should == alexandria_admin_user_url(:id => admin.id)
    end
  ...
  describe "#new" do
    it "returns 200 when logged in as superadmin" do
      ...
      visit new_alexandria_admin_user_url
      page.status_code.should == 200
      current_url.should == new_alexandria_admin_user_url
    end
  ...
  describe "#edit" do
    it "returns 200 when logged in as superadmin" do
      ...
      visit edit_alexandria_admin_user_url(:id => admin.id)
      page.status_code.should == 200
      current_url.should == edit_alexandria_admin_user_url(:id => admin.id)
    end
  ...
  describe "#update" do
    it "updates AdminUser when logged in as superadmin" do
      login_as superadmin
      page.driver.put("/alexandria/admin_users/#{admin.id}", { :admin_user => { :email => "test_case_email@example.com" } } )
    ...
    it "returns 403 when logged in as admin" do
      ...
      page.driver.put("/alexandria/admin_users/#{moderator.id}", { :admin_user => { :email => "test_case_email@example.com" } } )
  ...
  describe "#edit_account" do
    it "returns 200 when logged in as superadmin" do
      ...
      visit edit_account_alexandria_admin_users_url
      page.status_code.should == 200
      current_url.should == edit_account_alexandria_admin_users_url
    end
  ...
  describe "#reset_all_passwords_alexandria_admin_users" do
    it "returns 200 when logged in as superadmin" do
      login_as superadmin
