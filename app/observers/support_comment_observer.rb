    ...
    unless Rails.env.test?
      if support_comment.user_profile.blank?
        ...
        message = Message.create_system(:subject => "Support ticket update",
                  :body => "#{support_comment.support_ticket_admin_user_display_name} has made a new comment on your support ticket ##{support_comment.support_ticket_id}. [View Support Ticket](#{support_url(support_comment.support_ticket)})",
