DaBvRails::Application.configure do
  ...
  # config.assets.precompile += %w(active_admin.css active_admin.js stylesheets/application/*.* stylesheets/fonts/*.* stylesheets/themes/*.* stylesheets/top_level/*.* fonts/*.* javascripts/*.*)
  config.assets.precompile = [/^[^active_admin]/]
